...
\begin{flalign}
( \vec{f_1}^{-1} \circ \vec{f_2}^{-1} \circ \vec{f_4} \circ \vec{f_3} \circ \vec{f_2} \circ \vec{f_1}) (\vec{b}) & = \begin{bmatrix}
...
\textbf{Scale ( $\vec{f_1}^{-1} \circ \vec{f_2}^{-1} \circ \vec{f_4} \circ \vec{f_3} \circ \vec{f_2} \circ \vec{f_1}) (\vec{b})$ by $\norm{a}$}

\begin{flalign}
  \norm{a} * ( \vec{f_1}^{-1} \circ \vec{f_2}^{-1} \circ \vec{f_4} \circ \vec{f_3} \circ \vec{f_2} \circ \vec{f_1}) (\vec{b})
  & = \norm{a} *  \frac{1}{\norm{a}} * \begin{bmatrix}
  a_2b_3 -a_3b_2     \\
  a_3b_1 +  -a_1b_3    \\ \\
  a_1b_2 -a_2b_1 \\
